...
export default function MobileNavigation({ links }: { links: MobileLink[] }) {
    ...
    return <div className="md:hidden">
        ...
        {open && <div className="fixed inset-x-0 top-16 z-50 border-b border-gray-200 bg-white/98 p-3 shadow-xl backdrop-blur-xl dark:border-gray-800 dark:bg-gray-900/98" id="mobile-dashboard-navigation">
            <div className="mb-2 flex items-center justify-between px-1"><p className="text-xs font-bold uppercase tracking-[0.18em] text-gray-400">Shop navigation</p><Link href="/dashboard/settings" onClick={() => setOpen(false)} className="text-sm font-semibold text-blue-600">Settings</Link></div>
